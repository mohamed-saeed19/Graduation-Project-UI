...
export default function Homepage() {
  ...
  const Array1 = [
    ...
    {
      text: t("Account"),
      icon: { icon: <i className="fa-regular fa-circle-user"></i> },
      path: "account",
    },
    {
      text: t("History"),
    ...
    },
    {
      ...
      icon: { icon: <i className="fa-solid fa-unlock"></i> },
      path: "forgetpasswordsecond",
    },
    {
      text: t("About Us"),
      icon: { icon: <i className="fa-solid fa-people-group"></i> },
      path: "aboutus",
    },
  ];
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      >
        ...
        {localStorage.getItem("imgCover") ==
        "https://speech-emotions-874.onrender.com/null" ? (
          <Avatar
            sx={{
              mx: "auto",
              width: open ? 88 : 44,
        ...
        <List className="logout">
          <ListItem disablePadding sx={{ display: "block" }}>
            ...
            >
              <div className="icon-slider mx-1">
                <i className="fa-solid fa-right-from-bracket"></i>
              </div>
              <ListItemText
                onClick={() => {
                  setOpen(false), handleAlert(logOut);
                }}
                className="sidebar "
                primary={t("Log Out")}
                sx={{ opacity: open ? 1 : 0 }}
