...
import img from "../../image/Tablet_login-cuate-removebg-preview 1.png";
import "./Auth.css";
  ...
  async function sendUserData() {
    try {
      ...
      let { data } = await axios.post(
        `https://speech-emotions-874.onrender.com/users/signin`,
        user
      );
    ...
    <div className="container ">
      <div className="row  align-items-center row-login">
        <div className="col-md-6 p-3">
          <div>
            <h3 className="sub-title login " style={{ color: "var(--text)" }}>
              Welcome Back
            </h3>
            <p
            ...
            <form onSubmit={submitLogin}>
              ...
              <div className="text-center">
                ...
                <Link to="/forgetpassword">
                  {" "}
                  <h6
                    className="sub-title ms-4 py-3 fs-4 ForgetPassword text-center"
                    style={{ color: "#dc0b62" }}
                  >
                    Forgot Password ?
                  </h6>
                ...
                <Link to="/register">
                  {" "}
                  <h6 className="sub-title fs-6" style={{ color: "#dc0b62" }}>
                    Sign Up{" "}
                  </h6>
                </Link>
              </div>
